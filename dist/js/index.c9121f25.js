...
})({"4Z1YQ":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "72a6d6c6c9121f25";
"use strict";
...
},{}],"eA1NR":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const text1 = document.querySelector(".purchase-section-content p:nth-of-type(1)");
    const text2 = document.querySelector(".purchase-section-content p:nth-of-type(2)");
    ...
    spans.forEach((span)=>{
        ...
        (0, _gsap.gsap).fromTo(span, {
            ...
            ease: "power1.inOut",
            scrollTrigger: {
                trigger: ".purchase-section-heading",
                start: "top+=100 60%",
                end: "top+=300 40%",
    ...
    (0, _gsap.gsap).fromTo(logoDargaud, {
        opacity: 0
    }, {
        opacity: 1,
        duration: 1,
    ...
    (0, _gsap.gsap).fromTo(footerLinks, {
        opacity: 0
    }, {
        opacity: 1,
        duration: 1,
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk"}]},["4Z1YQ","eA1NR"], "eA1NR", "parcelRequire0300")

//# sourceMappingURL=index.c9121f25.js.map
