...
})({"bghZg":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "79c775cfea3cb2d0";
"use strict";
...
},{}],"2pSVM":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const claudeCard = document.querySelector(".character-section-card:nth-of-type(1)");
    const baronCard = document.querySelector(".character-section-card:nth-of-type(3)");
    const roiCard = document.querySelector(".character-section-card:nth-of-type(4)");
    const ysaCard = document.querySelector(".character-section-card:nth-of-type(2)");
    ...
    const hiddenClaude = document.querySelector(".character-section-image img:nth-of-type(2)");
    const hiddenYsa = document.querySelector(".character-section-image img:nth-of-type(3)");
    const hiddenBaron = document.querySelector(".character-section-image img:nth-of-type(4)");
    const hiddenRoi = document.querySelector(".character-section-image img:nth-of-type(5)");
    ...
    let roiDiscovered = 0;
    const tlAppear = (0, _gsap.gsap).timeline();
    const tlDiseappear = (0, _gsap.gsap).timeline();
    ...
    const targetPositionStart = characterSection.getBoundingClientRect().top + window.scrollY;
    const targetPositionEnd = hiddenClaude.getBoundingClientRect().top + window.scrollY;
    ...
    claudeCard.addEventListener("click", function() {
        ...
        tlAppear.to(allCards, {
            ...
            duration: 0.2,
            pointerEvents: "none"
        }, "<").to(".character-section-pop-up-claude .character-section-pop-up-heading span:nth-child(1)", {
            x: 0,
            duration: 1
        }).to(".character-section-pop-up-claude p", {
            x: 0,
            duration: 1
        }, "<").to(".character-section-pop-up-claude .character-section-pop-up-image-1", {
            x: 0,
            duration: 1,
            opacity: 1,
            delay: 0.5
    ...
    baronCard.addEventListener("click", function() {
        ...
        tlAppear.to(allCards, {
            ...
            duration: 0.2,
            pointerEvents: "none"
        }, "<").to(".character-section-pop-up-baron .character-section-pop-up-heading span:nth-child(1)", {
            x: 0,
            duration: 1
        }).to(".character-section-pop-up-baron p", {
            x: 0,
            duration: 1
        }, "<").to(".character-section-pop-up-baron .character-section-pop-up-image-1", {
            x: 0,
            duration: 1,
            opacity: 1,
            delay: 0.5
    ...
    roiCard.addEventListener("click", function() {
        ...
        tlAppear.to(allCards, {
            ...
            duration: 0.2,
            pointerEvents: "none"
        }, "<").to(".character-section-pop-up-roi .character-section-pop-up-heading span:nth-child(1)", {
            x: 0,
            duration: 1
        }).to(".character-section-pop-up-roi p", {
            x: 0,
            duration: 1
        }, "<").to(".character-section-pop-up-roi .character-section-pop-up-image-1", {
            x: 0,
            duration: 1,
            opacity: 1,
            delay: 0.5
    ...
    ysaCard.addEventListener("click", function() {
        ...
        tlAppear.to(allCards, {
            ...
            duration: 0.2,
            pointerEvents: "none"
        }, "<").to(".character-section-pop-up-ysa .character-section-pop-up-heading span:nth-child(1)", {
            x: 0,
            duration: 1
        }).to(".character-section-pop-up-ysa p", {
            x: 0,
            duration: 1
        }, "<").to(".character-section-pop-up-ysa .character-section-pop-up-image-1", {
            x: 0,
            duration: 1,
            opacity: 1,
            delay: 0.5
    ...
    characterButton.forEach(function(button) {
        button.addEventListener("click", function(event) {
            ...
            if (claudeStatus === 1) {
                tlDiseappear.to(".character-section-pop-up-claude .character-section-pop-up-heading span:nth-child(1)", {
                    x: -1500,
                    duration: 0.5
                }).to(".character-section-pop-up-claude .character-section-pop-up-image-1", {
                    x: -1500,
            ...
            if (ysaStatus === 1) {
                tlDiseappear.to(".character-section-pop-up-ysa .character-section-pop-up-heading span:nth-child(1)", {
                    x: -1500,
                    duration: 0.5
                }).to(".character-section-pop-up-ysa .character-section-pop-up-image-1", {
                    x: -1500,
            ...
            if (baronStatus === 1) {
                tlDiseappear.to(".character-section-pop-up-baron .character-section-pop-up-heading span:nth-child(1)", {
                    x: -1500,
                    duration: 0.5
                }).to(".character-section-pop-up-baron .character-section-pop-up-image-1", {
                    x: -1500,
            ...
            if (roiStatus === 1) {
                tlDiseappear.to(".character-section-pop-up-roi .character-section-pop-up-heading span:nth-child(1)", {
                    x: -1500,
                    duration: 0.5
                }).to(".character-section-pop-up-roi .character-section-pop-up-image-1", {
                    x: -1500,
    ...
    (0, _gsap.gsap).fromTo(claudeCard, {
        y: 100,
        opacity: 0
    }, {
        duration: 0.5,
    ...
    (0, _gsap.gsap).fromTo(characterHeading, {
        y: 20,
        opacity: 0
    }, {
        duration: 0.5,
        scrollTrigger: {
            ...
            markers: false,
            onEnter: ()=>{
                (0, _gsap.gsap).to(characterHeading, {
                    delay: 0,
                    y: 0,
                    opacity: 1,
                    duration: 0.3
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk"}]},["bghZg","2pSVM"], "2pSVM", "parcelRequire0300")

//# sourceMappingURL=index.ea3cb2d0.js.map
